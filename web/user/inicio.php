...
<head>
    ...
    <link rel="stylesheet" href="../css/calidadAire.css">
                    ...
                    <div d-flex align-content-center>
                        <div class="row align-items-center rounded ">
                            ...
                            <div class="row justify-content-start">
                                ...
                                <div id="calidadAire" class="col text-md-center align-self-md-center">
                                    <h4>Calidad del Aire Hoy</h4>
                                    <h5>
                                        <?php include("../bd/calidadAire.php") ?>
                                    </h5>
                                </div>
                            </div>
                        </div>
