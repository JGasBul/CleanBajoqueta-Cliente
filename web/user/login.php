        ...
        <div class="row align-items-center">
            ...
            <div class="col-sm ">
                    ...
                    <div class="card-body ">
                        <form method="POST">
                            <div class="text-center">
                                <span class=" text-left badge rounded-pill text-bg-light shadow-lg  p-3 mb-3 w-75 align-items-center fs-5"> 
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col  align-middle">
                                                    <input type="email" class="form-control  border-0 " name="usuariologin" placeholder="Escribe tu email de usuario">
                                ...
                                <span class=" text-left badge rounded-pill text-bg-light shadow-lg  p-3 mb-3 w-75 align-items-center fs-5"> 
                                    <div class="container-fluid">
                                        <div class="row">
                                            ...
                                            <div class="col  align-middle">
                                                    <input type="password" class="form-control  border-0" name="contrasenialogin" placeholder="Escribe tu contraseña">
                                            </div>

                                            <div class="col-lg-1  align-middle">
                                                <img src="../assets/esconder.png"  width="30" height="30" alt="loginphoto">
                                            </div>
                                        </div>
                                    </div> 
                                </span>
                    ...
                    <div class="card-footer bg-info border-info">
                        <div class="row align-items-center justify-content-center ">
                            <div class="col-lg-1  justify-content-center">
                                <img src="../assets/manzana.png" class="align-right "  width="40" height="40" alt="iconotelefono">
                            </div>
                ...
                <div class=" text-md-center">
                    <a> ¿No tienes una cuenta?</a> <a class="text-success" href="../user/registroPage.php"> Regístrate</a>
                </div>
